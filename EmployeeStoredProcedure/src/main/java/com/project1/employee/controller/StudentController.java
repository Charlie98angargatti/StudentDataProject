...
public class StudentController {
	...
	public String post(@RequestBody @Valid StudentValid studentValid) {
    String stu=service.saveStudent(studentValid);
		return stu;
	...
	public Page<Student> getByPage(@RequestParam int pagenumber , @RequestParam int numberOfItems){
		PageRequest pageRequest = PageRequest.of(pagenumber, numberOfItems);
